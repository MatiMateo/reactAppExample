        ...
        <nav className="flex items-center justify-end w-full text-white">
          <div className={`${ menuMovil ? 'hidden' : 'flex'} absolute shadow-2xl slide-bottom shadow-black rounded-lg sm:relative sm:top-0 sm:z-10 p-2 flex-col items-center justify-center text-right w-full left-0 bg-black -z-10 opacity-95 top-[18vw] sm:flex sm:flex-row`}>
              ...
              <div className='w-full flex flex-col my-2 sm:m-0 sm:items-center'>
                <button onClick={toggleMenu} type='button' className='flex relative flex-row items-end justify-end'>
                  <span>
                  ...
                  Contacto 
                  <span>
                    <svg className="items-center w-4 h-6 hidden sm:flex" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
                  </span>
                </button>
